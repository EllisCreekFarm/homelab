...
<img src="https://raw.githubusercontent.com/elliscreekfarm/homelab/master/docs/src/assets/logo.png" align="center" width="144px" height="144px"/>
...
[![Renovate](https://img.shields.io/github/actions/workflow/status/elliscreekfarm/homelab/renovate.yaml?branch=master&label=&logo=renovatebot&style=for-the-badge&color=blue)](https://github.com/elliscreekfarm/homelab/actions/workflows/renovate.yaml)
...
The way Flux works for me here is it will recursively search the `kubernetes/service` folder until it finds the most top level `kustomization.yaml` per directory and then apply all the resources listed in it. That aforementioned `kustomization.yaml` will generally only have a namespace resource and one or many Flux kustomizations (`ks.yaml`). Under the control of those Flux kustomizations there will be a `HelmRelease` or other resources related to the application which will be applied.
